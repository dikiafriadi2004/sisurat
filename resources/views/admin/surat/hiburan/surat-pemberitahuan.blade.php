...
@section('title')
    Buat Surat Pemberitahuan Pajak Hiburan
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-1 anchor" id="basic">
                            Surat Pemberitahuan Pajak Hiburan
                        </h5>
                        <div class="mt-3">
                            <div>
                                <form action="{{ route('laporanpajakhiburan.suratpemberitahuan', $laporanpajakhiburan) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="humanfd-datepicker" name="tgl_surat_pemberitahuan"
                                            ...
                                            value="{{ $laporanpajakhiburan->tgl_surat_pemberitahuan }}">
                                    </div>
