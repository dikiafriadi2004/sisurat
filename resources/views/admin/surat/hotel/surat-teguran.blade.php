...
@section('title')
    Buat Surat Teguran Pajak Hotel
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-1 anchor" id="basic">
                            Surat Teguran Pajak Hotel
                        </h5>
                        <div class="mt-3">
                            <div>
                                <form action="{{ route('laporanpajakhotel.suratteguran', $laporanpajakhotel) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="humanfd-datepicker" name="tgl_surat_teguran"
                                            ...
                                            value="{{ $laporanpajakhotel->tgl_surat_teguran }}">
                                    </div>
