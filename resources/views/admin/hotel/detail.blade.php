                    ...
                    <div class="card-body">
                        ...
                        <div class="clearfix">
                            <div class="float-sm-start">
                                <h5 class="card-title mb-2">NPWPD: {{ $pajakhotel->npwpd }}</h5>
                            </div>
                        </div>

                        <div class="row mt-3">
                            <div class="col-md-6">
                                <h6 class="fs-16"> {{ $pajakhotel->nama_pemilik }}</h6>
                                <address>
                                    Alamat : {{ $pajakhotel->alamat_usaha }}
                                    <br>
                                    Phone : {{ $pajakhotel->no_hp }}
                                </address>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a href="{{ route('laporanpajakhotel.create', $pajakhotel->slug) }}"
                                ...
                                <div class="table-responsive table-borderless text-nowrap mt-3 table-centered">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($pajakhotel->laporan_pajak_hotel as $item)
                                                <tr>
